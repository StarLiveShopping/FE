...
import { moreProductsModal2Atom } from '@/state/modalState';
import { useAtom } from 'jotai';

const MoreProductsModal2 = () => {
  // jotai 설정 추가 필요
  const [isOpen, setIsOpen] = useAtom(moreProductsModal2Atom);
  ...
  return (
    <div className="absolute bottom-0 left-0 z-50 w-full lg:w-[30.6rem]">
...
export default MoreProductsModal2;
